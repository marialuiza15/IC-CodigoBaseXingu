...
output_path = r'C:\Users\maria\OneDrive\Desktop\IC\IC-CodigoBaseXingu\output\lista_apriori_cid_sinais.csv'

selected_cols = ['CID', 'SINAIS E SINTOMAS']
filename_suffix = "cid_sinais"
