...
selected_cols = ['HIPÓTESE DIAGNÓSTICO  -  HD', 'SINAIS E SINTOMAS']
filename_suffix = "hd_sinais"

input_path = r'C:\Users\maria\OneDrive\Desktop\IC\IC-CodigoBaseXingu\data\MAPA DIÁRIO PRODUÇÃO - AGOSTO 2024.csv'
output_path = r'C:\Users\maria\OneDrive\Desktop\IC\IC-CodigoBaseXingu\output\lista_apriori_hd_sinais.csv'
...
itemsets_n = frequent_itemsets[frequent_itemsets['itemsets'].apply(lambda x: len(x) == 2)]
